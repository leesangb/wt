...
- fca0bba: Label Herdr workspaces opened by `wt pr` with the pull request author's display name and a title trimmed of conventional commit and configured issue prefixes.
